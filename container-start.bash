main(){
    ...
    if [[ $1 != "--" ]] && [[ $1=="--network" ]]; then
        ...
        DOCKER_NETWORK_OPTIONS="--net=br0 --ip 10.10.238.5 "
	    ...
	    if [[ $1 == "fhi" ]]; then
		    ...
		    DOCKER_NETWORK_OPTIONS="--net=br0 --ip 172.16.0.203"
    ...
    docker run -it --rm \
        ...
        ${DOCKER_NETWORK_OPTIONS} \
        --privileged \
        franka-control 'http://172.16.0.203:11311' '172.16.0.203' '/franka' '172.16.0.2'
}
